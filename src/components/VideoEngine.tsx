      ...
      {hasFatalError && (
        <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-[#0a0c10]/95 backdrop-blur-sm text-center p-6 animate-in fade-in duration-300">
          ...
          <div className="flex flex-col gap-3 w-full max-w-sm">
            ...
            <button onClick={() => launchExternalPlayer(false)} className="px-5 py-3 bg-slate-700 hover:bg-slate-600 border border-slate-600 text-white text-sm font-semibold rounded-lg flex items-center justify-center gap-2 transition-all shadow-[0_0_15px_rgba(255,255,255,0.1)]">
