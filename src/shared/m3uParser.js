// ----------------------------------------------------
// THE UNIFIED SHARED M3U PARSER
// Used by both the Browser (Frontend) and Cloudflare (Backend)
// ----------------------------------------------------

export function generateStableId(sourceId, streamUrl, count) {
  let hash = 5381;
...
export function isVod(streamUrl, metadata) {
...
// ----------------------------------------------------
export function parseM3UString(text, sourceId, fallbackName = 'Unknown Playlist') {
